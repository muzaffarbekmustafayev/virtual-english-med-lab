...
async function capture() {
  ...
  page.on('pageerror', err => console.log('REACT PAGE ERROR:', err.message, err.stack));
  ...
  await page.evaluate(() => {
    ...
    const b1 = btns.find(b => b.textContent.includes('1') || b.querySelector('svg'));
    if (b1) {
      console.log('Found b1:', b1.outerHTML);
      b1.click();
    }
  });
