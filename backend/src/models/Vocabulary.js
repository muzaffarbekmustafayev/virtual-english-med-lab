...
const Vocabulary = sequelize.define('Vocabulary', {
  ...
  translation:    { type: DataTypes.STRING(150), allowNull: true },
  translation_uz: { type: DataTypes.STRING(150), allowNull: true },
  translation_ru: { type: DataTypes.STRING(150), allowNull: true },
  translation_en: { type: DataTypes.STRING(150), allowNull: true },
